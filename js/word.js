...
Vue.component('word', {
  ...
  <div class="word-card" id="word-card-app">
    ...
    <div class="expandable-list-container" v-if="forms.kreb !== null">
      <div class="center-block">
        ...
        <div v-for="kanji of w.kanjis" v-if="forms.kreb.indexOf(kanji.title) !== -1">
          <div class="hr-title"><span>{{kanji.title}}</span></div>
    ...
    <div class="center-block" style="margin-top: 0.8em; margin-bottom: 0.8em">
    ...
    <div class="hr-title center-block" v-if="w.sentences.length > 0 || w.rawSentences.length > 0">
      <span style="margin: 1em 0">Sentences</span>
    </div>

    <div class="word-sentences word-sentences-structured center-block" v-if="w.sentences.length > 0">
    ...
    <div class="word-sentences center-block" v-if="w.rawSentences.length > 0">
